...
Înainte ca utilizatorii sa poată interacţiona cu aplicatia, aceştia vor trebui să-şi creeze un cont, sau dacă au deja un cont sa se autentifice, cu ajutorul modulului de autentificare. Acesta este compus dintr-o pagina cu 2 funcţionalităţi Autentificare si Înregistrare.
...
\caption{Tablou de bord Materie - Câmp alegere Timp - data(stanga), ora(mijloc), minut(dreapta)}
